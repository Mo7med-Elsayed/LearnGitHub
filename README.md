...
5. git log --oneline -all                     = show the commit history
...
5. git checkout <commitSHA>                   = move the head pointer to a specific commit (Display the SHA using git log --oneline --all)
